...
public static class RendererRegistrationExtension
{
    public static void AddModelRenderers(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IContentRenderer>(new PhaseBannerRenderer { Order = 1 })
                ...
                .AddSingleton<IContentRenderer>(new Heading3Renderer { Order = 7 })
                .AddSingleton<IContentRenderer>(new Heading4Renderer { Order = 8 })
                .AddSingleton<IContentRenderer>(new Heading5Renderer { Order = 9 })
                .AddSingleton<IContentRenderer>(new Heading6Renderer { Order = 10 })
