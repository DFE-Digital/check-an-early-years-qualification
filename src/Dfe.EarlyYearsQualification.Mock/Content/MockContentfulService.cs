...
{
    private const string WhereQualificationAwardedPagePath = "/questions/where-was-the-qualification-awarded";
        ...
        return entryId switch
               {
                   AdvicePages.QualificationsAchievedOutsideTheUk =>
                       await Task.FromResult(CreateAdvicePage("Qualifications achieved outside the United Kingdom",
                                                              body, WhereQualificationAwardedPagePath)),
        ...
        return new DateQuestionPage
               {
                   ...
                   BackButton = new NavigationLink
                                {
                                    DisplayText = "TEST",
                                    Href = WhereQualificationAwardedPagePath,
                                    OpenInNewTab = false
                                }
               };
    }
