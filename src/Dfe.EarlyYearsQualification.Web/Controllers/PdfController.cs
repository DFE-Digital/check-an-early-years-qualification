...
[Route("/pdf")]
public class PDfController : ServiceController
{
    [HttpPost("generate")]
    [IgnoreAntiforgeryToken]
    public async Task<IActionResult> Generate(string doc)
    {
        ...
        await page.SetContentAsync(doc, new PageSetContentOptions { WaitUntil = WaitUntilState.NetworkIdle, Timeout = 30000 });
        await page.AddStyleTagAsync(new PageAddStyleTagOptions
                                    {
                                        Content = @"@charset ""UTF-8"";:root {
...
@font-face {
    ...
    font-style: normal;
    font-weight: 400;
    src: url(/assets/fonts/light-94a07e06a1-v2.woff2?v=5.11.0) format(""woff2""),url(/assets/fonts/light-f591b13f7d-v2.woff?v=5.11.0) format(""woff"");
...
@font-face {
    ...
    font-style: normal;
    font-weight: 700;
    src: url(/assets/fonts/bold-b542beb274-v2.woff2?v=5.11.0) format(""woff2""),url(/assets/fonts/bold-affa96571d-v2.woff?v=5.11.0) format(""woff"");
    font-display: fallback
}
...
.govuk-error-summary__list,.govuk-error-summary__list li:last-child {
    margin-bottom: 0
}
...
.govuk-file-upload-button--empty:active,.govuk-file-upload-button--empty:focus,.govuk-file-upload-button--empty:hover {
    background-color: #f3f2f1
}

.govuk-file-upload-button--empty:active .govuk-file-upload-button__status,.govuk-file-upload-button--empty:focus .govuk-file-upload-button__status,.govuk-file-upload-button--empty:hover .govuk-file-upload-button__status {
    background-color: #d2e2f1
}
...
.govuk-file-upload-button--dragging.govuk-file-upload-button--empty .govuk-file-upload-button__pseudo-button,.govuk-file-upload-button--dragging.govuk-file-upload-button--empty:not(:disabled) .govuk-file-upload-button__status {
    background-color: #fff
}
...
.govuk-footer__copyright-logo:before {
    ...
    width: 100%;
    padding-top: 112px;
    background-image: url(/assets/images/govuk-crest.svg?v=5.11.0);
...
@supports ((-webkit-mask-position: initial) or (mask-position:initial)) {
    .govuk-footer__copyright-logo:before {
        ...
        -webkit-mask-image: url(/assets/images/govuk-crest.svg?v=5.11.0);
        mask-image: url(/assets/images/govuk-crest.svg?v=5.11.0);
...
.govuk-template--rebranded .govuk-header__navigation-item--active a:hover,.govuk-template--rebranded .govuk-header__navigation-item--active a:link,.govuk-template--rebranded .govuk-header__navigation-item--active a:visited {
    color: inherit
}
...
.govuk-header__navigation-item--active a:focus,.govuk-template--rebranded .govuk-header__navigation-item--active a:focus {
    color: #0b0c0c
}
...
.govuk-service-navigation__link:active,.govuk-service-navigation__link:focus {
    color: #0b0c0c
}
...
.govuk-template--rebranded .govuk-service-navigation--inverse .govuk-service-navigation__link:active,.govuk-template--rebranded .govuk-service-navigation--inverse .govuk-service-navigation__link:hover {
    color: hsla(0,0%,100%,.99)
}
...
.govuk-summary-card__action,.govuk-summary-list__actions-list-item {
    display: inline-block
}
...
@media (max-width: 40.0525em) {
    ...
    .govuk-summary-card__action:last-child,.govuk-summary-list__actions-list-item:last-child {
        margin-right: 0;
        padding-right: 0;
        border: 0
    }
...
@media (min-width: 40.0625em) {
    ...
    .govuk-summary-card__action:not(:first-child),.govuk-summary-list__actions-list-item:not(:first-child) {
        border-left: 1px solid #b1b4b6
    }

    .govuk-summary-card__action:first-child,.govuk-summary-list__actions-list-item:first-child {
        margin-left: 0;
        padding-left: 0;
        border: 0
    }
...
.govuk-visually-hidden:after,.govuk-visually-hidden:before {
    content: "" ""
}
...
.chevron-card__link:hover::after {
    border-color: #003078;
}
...
@media (min-width: 641px) and (max-width: 998px) {
    #clear-search {
...
/* Custom Feedback Banner Component */
...
/* Custom Qualification Result component */
.govuk-inset-text.qualification-result-success {
    border-left-color: #00703c;
}

.govuk-inset-text.qualification-result-failure {
...
.ud-feedback__prompt-questions--get-help {
    border-top: 1px solid #b1b4b6
}
...
.ud-feedback__prompt-question-answer {
    display: flex;
    align-items: center
}
...
.ud-feedback__prompt-question, .ud-feedback__prompt-success {
    font-family: ""GDS Transport"", arial, sans-serif;
    -webkit-font-smoothing: antialiased;
    -moz-osx-font-smoothing: grayscale;
    font-weight: 700;
...
.ud-feedback__prompt-question {
    margin: 0;
    padding-bottom: 10px
}

.ud-feedback__prompt-question:focus {
    outline: 0
}
...
.ud-feedback__button:focus, .ud-feedback__button:focus:not(:active):not(:hover) {
    background: #fd0;
    border-color: #0b0c0c;
    box-shadow: 0 5px 0 #0b0c0c
}

.ud-feedback__button:active {
    color: #0b0c0c
}

.ud-feedback__button:hover {
    background: #b1b4b6;
    color: #0b0c0c
}

.ud-feedback__button:link, .ud-feedback__button:visited {
    color: #0b0c0c
}

.ud-feedback__button:link:focus, .ud-feedback__button:link:active, .ud-feedback__button:visited:focus, .ud-feedback__button:visited:active {
    color: #0b0c0c
}

.ud-feedback__option-list {
    display: flex;
    list-style-type: none;
    margin: 0;
    padding: 0
...
.ud-feedback__option-list-item:last-child {
    margin-left: 10px
}
...
.ud-feedback__option-list-item .ud-feedback__button {
    min-width: 100px
}
...
.govuk-main-wrapper:has(#ud-feedback) {
    padding-bottom: 0;
}
...
.feedback-container.mobile-only {
    display: inline-block;
    margin-bottom: 50px;
}

.feedback-container.desktop-only {
    display: none;
}
...
/* The govuk-inset-text has additional margin that makes the gap between the heading and main content too big in the 
   cannot find a qualification page. As this content is inserted from the CMS, we can't change the styling on the element
   itself. This aims to target the first div that is a govuk inset text element */
#advice-page-body > :first-child:is(div.govuk-inset-text) {
    margin-top: 0;
}

.govuk-section-break__overrides {
    border-color: #8eb8dc;
    border-bottom: #8eb8dc;
...
.govuk-footer__section > .govuk-footer__list > .govuk-footer__list-item > p {
    margin-bottom: 0!important;
}
"
                                    });

        var fileBytes = await page.PdfAsync(new PagePdfOptions
                                            {
                                                Format = "a4",
                                                Margin = new Margin {Top = "20mm", Bottom = "20mm", Left = "10mm", Right = "10mm"}
                                            });
        
        // await System.IO.File.WriteAllBytesAsync("system-generated.pdf", fileBytes);
        
        // This stops 'byte-shaving' which was corrupting the output file
        var bytesEncoded = Convert.ToBase64String(fileBytes);
        return new OkObjectResult(bytesEncoded);
    }
}