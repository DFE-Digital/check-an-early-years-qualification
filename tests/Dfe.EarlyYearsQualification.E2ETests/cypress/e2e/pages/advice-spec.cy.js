describe("A spec that tests advice pages", () => {
    ...
    it("Checks the level 7 between 1 Sept 2014 and 31 Aug 2019 details are on the page", () => {
        cy.setCookie('user_journey', '%7B%22WhenWasQualificationStarted%22%3A%227%2F2015%22%7D');
        cy.visit("/advice/level-7-qualifications-started-between-1-sept-2014-and-31-aug-2019");

        cy.get("#advice-page-heading").should("contain.text", "Level 7 qualifications started between 1 September 2014 and 31 August 2019");
        cy.get("#advice-page-body").should("contain.text", "Test Advice Page Body");
