...
public class AccessibilityStatementControllerTests
{
    ...
    public async Task Index_NoContent_NavigatesToErrorPageAsync()
    {
        ...
        mockContentService.Setup(x => x.GetAccessibilityStatementPage(AccessibilityStatements.Service))
    ...
    public async Task Index_ContentFound_ReturnsCorrectModel()
    {
        ...
        mockContentService.Setup(x => x.GetAccessibilityStatementPage(AccessibilityStatements.Service)).ReturnsAsync(expectedContent);
    ...
    [TestMethod]
    public async Task AccessibilityStatementEYQL_NoContent_NavigatesToErrorPageAsync()
    {
        var mockContentService = new Mock<IContentService>();
        var mockLogger = new Mock<ILogger<AccessibilityStatementController>>();
        var mockAccessibilityStatementMapper = new Mock<IAccessibilityStatementMapper>();
        ...
        mockContentService.Setup(x => x.GetAccessibilityStatementPage(AccessibilityStatements.EYQL))
                          .ReturnsAsync((AccessibilityStatementPage?)null);

        var result = await controller.AccessibilityStatementEYQL();

        result.Should().NotBeNull();
        result.Should().BeEquivalentTo(new RedirectToActionResult("Index", "Error", null));

        mockLogger.VerifyError("No content for the EYQL accessibility statement page");
    }

    [TestMethod]
    public async Task AccessibilityStatementEYQL_ContentFound_ReturnsCorrectModel()
    {
        var mockContentService = new Mock<IContentService>();
        var mockLogger = new Mock<ILogger<AccessibilityStatementController>>();
        var mockAccessibilityStatementMapper = new Mock<IAccessibilityStatementMapper>();
        ...
        mockContentService.Setup(x => x.GetAccessibilityStatementPage(AccessibilityStatements.EYQL)).ReturnsAsync(expectedContent);
