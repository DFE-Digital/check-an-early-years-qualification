...
public class ConfirmQualificationControllerTests
{
    ...
    public async Task Index_PageDetailsAndQualificationFound_MapsModelAndReturnsView()
    {
        ...
        mockContentService.Setup(x => x.GetQualificationById("Some ID")).ReturnsAsync(new Qualification("Some ID", "Qualification Name", "NCFE", 2, "2014", "2019",
    ...
    [TestMethod]
    public async Task Post_ValidModel_PassedYes_RedirectsToQualificaitonDetailsAction()
    {
        var mockLogger = new Mock<ILogger<ConfirmQualificationController>>();
        var mockContentService = new Mock<IContentService>();
