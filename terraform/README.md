...
| <a name="input_google_search_console_tag"></a> [google\_search\_console\_tag](#input\_google\_search\_console\_tag) | The Google Search Console tag | `string` | `""` | no |
...
| <a name="input_otel_service_name"></a> [otel\_service\_name](#input\_otel\_service\_name) | Service name for the Splunk integration | `string` | n/a | yes |
...
| <a name="input_splunk_access_token"></a> [splunk\_access\_token](#input\_splunk\_access\_token) | Access token for the Splunk integration | `string` | n/a | yes |
| <a name="input_splunk_port"></a> [splunk\_port](#input\_splunk\_port) | Port number for the Splunk integration | `string` | n/a | yes |
| <a name="input_splunk_realm"></a> [splunk\_realm](#input\_splunk\_realm) | Realm for the Splunk integration | `string` | n/a | yes |
